                    ...
                    <tbody>
                        <?php foreach ($participantNames as $index => $name): ?>
                            <tr>
                                ...
                                <td><input type="number" name="participantEmail[]" value="<?= htmlspecialchars($participantEmails[$index]); ?>" required></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <?php for ($i = 1; $i <= $participantCount; $i++): ?>
                            <tr>
                                ...
                                <td><input type="number" name="participantEmail[]" required></td>
                            </tr>
                        <?php endfor; ?>
                    </tbody>
                </table>
